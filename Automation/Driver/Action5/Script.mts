...
'			Call AddFailureDescToTCResultFile( sDesc,ObjectType,sName,Method,sArgs)
	...
	sTestCaseName = adoRS("TestCaseName") & ""
	sTCID = adoRS("TCID") & ""
	sTCDetails= RetrieveOrderDetailsFromOutputXcelFile_fn()
	If sTCDetails="No Row" Then
		ExitAction("Skip")
	End If
...
'	Call AddTestCaseToTCResultFile(sTCID,sTestCaseName    ,"Not Executed") ''Reporting to xml
	...
	If secondPartAvailable="N" Then
		If sTCResult="PASS-FirstPart" or sTCResult="Pass" Then
			ExitAction("Pass")
		else
			ExitAction("Fail")
		End If
	...
	If sTCResult = "Pass"  and sJourneyType = "SecondPartOnly"Then
		ExitAction("PassAlready")
	End If
